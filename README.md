...
[![lerna version](https://img.shields.io/github/package-json/dependency-version/knownasilya/ember-chessboard/dev/lerna)](https://lerna.js.org/)
[![pnpm version](https://img.shields.io/github/package-json/packageManager/knownasilya/ember-chessboard)](https://pnpm.io/)
[![Generate Release Candidate](https://github.com/knownasilya/ember-chessboard/actions/workflows/release.yml/badge.svg?event=workflow_dispatch)](https://github.com/knownasilya/ember-chessboard/actions/workflows/release.yml)
...
```sh
git clone git@github.com:knownasilya/ember-chessboard.git
```
